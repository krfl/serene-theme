#!/bin/bash
# Serene Night Clarity - LSCOLORS configuration for BSD ls (macOS default)
# Source this file in your shell: source serene-night-clarity-bsd.sh
...
# Serene Night Clarity mapping:
# directories: green (Cx - bold green, default bg)
...
echo "Serene Night Clarity (BSD/macOS) colors loaded"
